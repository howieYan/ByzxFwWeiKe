...
export default class Banner extends React.Component {
    ...
    async loadAsync () {
        try {
            let data = await Utils.LoadPost(Utils.size.url + '/v1/front/banner'); // banner
        ...
        this.state.list.forEach((v, i) => {
            allChild.push(
                <View  style={styles.headerBanner} key={i}>
                    <Image source={{ uri: v.ad_thumb }} style={styles.headerBanner}/>
                </View>
            )
        });
        return allChild;

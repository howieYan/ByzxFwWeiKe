...
export default class Registe extends React.Component {
                            ...
                            <View style={styles.LoginInputRight}>
                                <View style={{
                                    ...
                                    <TextInput
                                        ...
                                        placeholder={'设置密码（6-20位数字与字母组合）'}
                                    />
                                </View>
                            </View>
                        </View>
                        <View style={styles.LoginInput}>
                            <Image style={styles.LoginInputUserRecommended} source={require('../Image/Login/Recommended.png')}/>
                            <View style={styles.LoginInputRight}>
                                <View style={{
                                    borderBottomColor: '#F2F1F2',
                                    borderBottomWidth: 1 }}>
    ...
    async LoadRegiste () {
        try {
            ...
            formData.append('referralCode', this.state.referralCode);
            formData.append('deviceId', DeviceInfo.getUniqueID());
            let data = await Utils.LoadPost(Utils.size.url + '/v1/auth/register', formData);
            if (Number(data.code) === 0) {

                    ...
                    <TouchableOpacity key={i} activeOpacity={0.5} onPress={this.onBookButton.bind(this, v)}>
                        <View style={styles.VideoNavLeft}>
                            <View style={i % 2 === 0 ? styles.VideoNavPadd: styles.VideoNavPaddRight}>
                                {/*<CachedImageComponent uri={v.pg_thumb} style={width: '100%',borderRadius: 3,height: 100}/>*/}
                                <Image source={{uri: v.pg_thumb, cache: 'force-cache',}}  style={styles.VideoNavLeftImg}/>
                                <Text style={styles.VideoNavStatusBarLeftText} numberOfLines={1}>{v.pg_title}</Text>

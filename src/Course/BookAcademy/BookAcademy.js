    ...
    render() {
        return (
            <View style={styles.content}>
                <ImageBackground source={{uri: this.state.data.art_thumb}}
                                 style={styles.BgImgImage}>
                ...
                <SwRefreshScrollView
                    ...
                    <View style={styles.content}>
                        <View style={styles.BookDetailsHeader}>
                            <Image style={styles.BookDetailsHeaderUserImg}
                                   source={{uri: this.state.data.art_avatar}}/>
                            <View style={styles.BookDetailsHeaderUserTime}>
                                <Text style={styles.BookDetailsHeaderUserName}>北邮在线</Text>
                            </View>
                            <Text
                                style={styles.BookDetailsHeaderUserTimeText}>{this.getTime(this.state.data.art_created)}小时前</Text>
                        </View>
                        <View style={styles.BookDetailsTitle}>
                            <Text
                                style={styles.BookDetailsTitleText}>{this.state.data.art_title}</Text>
                        </View>
                        <View style={styles.BookDetailsConter}>
                            <WebView
                                ...
                                style={{flex: 1, height: Utils.size.height}}>
                            </WebView>
                            {/*<WebView*/}

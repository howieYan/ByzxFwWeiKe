        ...
        return (
            <View style={styles.content}>
                <ScrollableTabView
                    ...
                    <PayCourse navigation={this.props.navigation} keywords={this.props.keywords} tabLabel='付费课程'/>
                    <FreeCourse navigation={this.props.navigation} keywords={this.props.keywords} tabLabel='免费课程'/>
                </ScrollableTabView>
            </View>
        );
    }
